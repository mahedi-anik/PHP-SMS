...
<?php
 ...
 if(isset($_POST['submit'])){
	...
	$select = "SELECT * from enrollments LEFT JOIN users on enrollments.studentid=users.id LEFT JOIN section on enrollments.sectionid=section.sectionid WHERE enrollments.studentid = '$studentid' and enrollments.sectionid= '$sectionid' ";
