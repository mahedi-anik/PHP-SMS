...
if(isset($_POST['submit'])){
   ...
   if($password != $cpass){
         ...
         $insert = "UPDATE `users` SET `name`='$name',`username`='$username',`email`='$email',`mobile`='$mobile',`password`='$password',`role`='$roleid',`status`='$status',`departmentid`='$departmentid' WHERE id = $id";
					...
					<div class="col-lg-12 col-md-12">
						<div class="card" style="min-height:485px">
							<div class="card-header card-header-text">
								<h2 class="card-title" style="text-align: center;">Update Department Admin Info </h2>
								<hr>
							</div>
